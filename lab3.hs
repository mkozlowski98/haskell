...
walk2 :: IO ()
walk2 = runActivity (Activity initialDirectedCoord handleDirectedEvent drawDirectedState)
...
walk3 :: IO ()
walk3 = runActivity (resettable (Activity initialDirectedCoord handleDirectedEvent drawDirectedState))

walk4 :: IO ()
walk4 = runActivity (withStartScreen (resettable (Activity initialDirectedCoord handleDirectedEvent drawDirectedState)))
